    ...
    <div class="menu_bar" ref="sidebar" :class="{ 'hidden_menu': isActive }">
        ...
        <div class="section_footer">
            ...
            <div class="form-group">
                <Multiselect v-model="targetTenant" :options="tenantsAvailable" valueProp="tenantId" label="tenantName"
                    class="custom-select-modal" :searchable="true" placeholder="select newTenant..."
...
import { userTenantSummaryDTO } from '@/interfaces/templates/TenantInterface.js';
...
onMounted(async () => {
    ...
    tenantsAvailable.value = await getTenantByUser()
